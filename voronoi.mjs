...
["_app_init","_app_draw","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'voronoi.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('voronoi.wasm', import.meta.url).href;
}
...
/** @type {function(...*):?} */
var _app_init = Module["_app_init"] = createExportWrapper("app_init");
/** @type {function(...*):?} */
var _app_draw = Module["_app_draw"] = createExportWrapper("app_draw");
/** @type {function(...*):?} */
